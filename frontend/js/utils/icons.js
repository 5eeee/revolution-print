// SVG Icon Library — строгие деловые иконки (Lucide/Feather style)
// Использование: icon('home') или icon('home', 18, '#555')
const ICONS = {
  // Навигация
  ...
  factory:    '<path d="M2 20h20"/><path d="M5 20V8l5 4V8l5 4V4h3a2 2 0 012 2v14"/>',
  ...
  fileDown:   '<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><polyline points="9 15 12 18 15 15"/>',
  notes:      '<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/>',
  ...
  palette:    '<circle cx="13.5" cy="6.5" r="1.5"/><circle cx="17.5" cy="10.5" r="1.5"/><circle cx="8.5" cy="7.5" r="1.5"/><circle cx="6.5" cy="12" r="1.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 011.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.555C21.965 6.012 17.461 2 12 2z"/>',
  phone:      '<path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/>',

  // Статусы (точки)
  dotRed:     '<circle cx="12" cy="12" r="5" fill="#ef4444" stroke="none"/>',
  dotOrange:  '<circle cx="12" cy="12" r="5" fill="#f97316" stroke="none"/>',
  dotYellow:  '<circle cx="12" cy="12" r="5" fill="#eab308" stroke="none"/>',
  dotGreen:   '<circle cx="12" cy="12" r="5" fill="#22c55e" stroke="none"/>',
};
...
function icon(name, size, color) {
  ...
  if (!path) return '';
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="${c}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle; flex-shrink: 0;">${path}</svg>`;
}
